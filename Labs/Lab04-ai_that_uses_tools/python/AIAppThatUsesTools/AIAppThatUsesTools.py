...
def main(): 
    ...
    try:
        ...
        # Go up two levels to Lab04-ai_that_uses_tools, then into brochures
        brochures_dir = os.path.join(script_dir, "..", "..", "brochures")
        brochures_dir = os.path.normpath(brochures_dir)
        print("brochures_dir =", brochures_dir)
        ...
        file_streams = [open(f, "rb") for f in glob.glob(os.path.join(brochures_dir, "*.pdf"))]
